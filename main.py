...
with col_hr_portal:
    if st.button("🔹 HR Portal", use_container_width=True, help="Access for HR personnel and Administrators", key="btn_hr_portal"):
        ...
        # If switching portals, clear session state related to the other portal's login/register tabs
        ...
        # Logout if switching portals while authenticated and current role doesn't match new portal
